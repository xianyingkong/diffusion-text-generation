...
<p style="font-size: smaller; text-align: center;">Source: <a href= "https://developer.nvidia.com/blog/improving-diffusion-models-as-an-alternative-to-gans-part-1"> Link to Page</a>/</p>
{: refdef}
<br>
...
<p style="font-size: smaller; text-align: center;">Source: <a href= "https://developer.nvidia.com/blog/improving-diffusion-models-as-an-alternative-to-gans-part-2/">Link to Page</a></p>
{: refdef}
<br>
...
<p style="font-size: smaller; text-align: center;">Source: <a href= "https://github.com/Shark-NLP/DiffuSeq/">Link to Page</a></p>
{: refdef}
<br>
